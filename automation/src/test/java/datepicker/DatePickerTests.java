...
public class DatePickerTests extends TestBase{
  ...
  public void beforeMethod() {
	  ...
	  page.navigate();
	  date = new DatePicker(page.getElement());
	  dateTime = new DateTimePicker(page.getElement());
  }
